...
#define ACTION_MOVE_N 	0
#define ACTION_MOVE_NE 	1
#define ACTION_MOVE_E 	2
#define ACTION_MOVE_SE 	3
#define ACTION_MOVE_S 	4
#define ACTION_MOVE_SW 	5
#define ACTION_MOVE_W 	6
#define ACTION_MOVE_NW 	7
